...
export default function Home() {
  return (
    <div className="grid grid-cols-2 gap-3.5 items-center  justify-items-center h-full bg-primary-foreground">
      {/**Input */}
      <Card className="items-end shadow-lg max-w-6/12 border-none bg-primary">
        {/**?????????????? */}
